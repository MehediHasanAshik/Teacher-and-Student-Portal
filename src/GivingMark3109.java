 ...
 * @author Lenovo
 */
public class GivingMark3109 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of CSE3109");
        ...
        button.setBounds(320, 450, 120, 40);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkcse3109(iid, qquiz1, aattendance1, ffinal1, grade, gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3109 f1 = new GivingMark3109();
    }
}
