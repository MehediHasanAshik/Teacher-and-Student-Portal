...
public class GivingMark3101 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of CSE3101");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkcse3101(iid, qquiz1, aattendance1, ffinal1, grade, gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3101 f1 = new GivingMark3101();
    }
}
