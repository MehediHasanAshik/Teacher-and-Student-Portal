 ...
 * @author Lenovo
 */
public class GivingMark3103 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of CSE3103");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkcse3103(iid, qquiz1, aattendance1, ffinal1, grade, gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3103 f1 = new GivingMark3103();
    }
}
