 ...
 * @author Lenovo
 */
public class GivingMark3104 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of CSE3104");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkcse3104(iid, aattendance1, online1, offline1, mid1, project1, grade,gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3104 f1 = new GivingMark3104();
    }
}
