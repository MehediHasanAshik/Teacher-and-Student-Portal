 ...
 * @author Lenovo
 */
public class GivingMark3115 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of HUM3115");
        ...
        button.setBounds(320, y1 + 220, 120, 40);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkhum3115(iid, qquiz1, aattendance1, ffinal1, grade, gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3115 f1 = new GivingMark3115();
    }
}
