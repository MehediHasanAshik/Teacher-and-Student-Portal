 ...
 * @author Lenovo
 */
public class GivingMark3108 extends JFrame {
    ...
    public void initComponents() {
        ...
        title = new JLabel("Mark Distribution Of CSE3108");
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int ii = 0; ii < ind; ii++) {
                    ...
                    db.insertMarkcse3108(iid, aattendance1, online1, offline1, mid1, project1, grade,gpa, total_mark);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        GivingMark3108 f1 = new GivingMark3108();
    }
}
